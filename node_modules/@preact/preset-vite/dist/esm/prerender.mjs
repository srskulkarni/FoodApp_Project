...
export function PrerenderPlugin({ prerenderScript, renderTarget, additionalPrerenderRoutes, } = {}) {
    ...
    return {
        ...
        async generateBundle(_opts, bundle) {
            ...
            const tmpDir = path.join(viteConfig.root, "node_modules", "@preact/preset-vite", tmpDirId);
            try {
            ...
            try {
				...
				`.replace(/^\t{5}/gm, "");
                const stack = await import("stack-trace").then(({ parse }) => parse(e).find(s => s.getFileName().includes(tmpDirId)));
