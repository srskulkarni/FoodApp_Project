...
function PrerenderPlugin({ prerenderScript, renderTarget, additionalPrerenderRoutes, } = {}) {
    ...
    return {
        ...
        config(config) {
            var _a, _b;
            userEnabledSourceMaps = !!((_a = config.build) === null || _a === void 0 ? void 0 : _a.sourcemap);
        ...
        async generateBundle(_opts, bundle) {
            ...
            const tmpDir = node_path_1.default.join(viteConfig.root, "node_modules", "@preact/preset-vite", tmpDirId);
            try {
            ...
            try {
				...
				`.replace(/^\t{5}/gm, "");
                const stack = await Promise.resolve().then(() => __importStar(require("stack-trace"))).then(({ parse }) => parse(e).find(s => s.getFileName().includes(tmpDirId)));
